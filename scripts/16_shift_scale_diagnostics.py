#!/usr/bin/env python3
# =============================================================================
# 16_shift_scale_diagnostics.py — model-free invariants and the diagnostic
...
#
# RUN FROM the master "X0123 copy" folder:  python3 scripts/16_shift_scale_diagnostics.py
