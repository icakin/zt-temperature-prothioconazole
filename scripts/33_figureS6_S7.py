...
plt.rcParams.update({"font.family":"sans-serif","font.sans-serif":["DejaVu Sans"],"font.size":9,"pdf.fonttype":42})
...
fig.savefig(f"{FIG_DIR}/FigureS6_kegg_pathways.png",dpi=300,bbox_inches="tight")
fig.savefig(f"{FIG_DIR}/FigureS6_kegg_pathways.pdf",bbox_inches="tight")
...
figw.savefig(f"{FIG_DIR}/FigureS7_gene_grid.png",dpi=300,bbox_inches="tight")
figw.savefig(f"{FIG_DIR}/FigureS7_gene_grid.pdf",bbox_inches="tight")
