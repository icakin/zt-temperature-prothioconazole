...
## Layout
    ...
    figures/      Final figures: Figure1-6 and FigureS1-S21 (png + pdf)
...
## Pipeline (run from the project root)
    ...
    50-71   Figures. Every manuscript figure is generated by R.
              ...
              Rscript scripts/make_supp_figures.R     # Figures S1-S21
...
## Reproducing Figure 6d-f
    ...
    tables/aox/ptc_sham_windows.csv             the interval of every well
      ...
      -> scripts/78_figureS21.R               denoising and background-drift checks
