...
## Layout
    ...
    figures/      Final figures: Figure1-6 and FigureS1-S20 (png + pdf)
...
## Pipeline (run from the project root)
    ...
    50-71   Figures. Every manuscript figure is generated by R.
              ...
              Rscript scripts/make_supp_figures.R     # Figures S1-S20
...
## Before you start
    ...
    Rscript scripts/00_check_packages.R              # what is installed, what is not
    Rscript scripts/00_check_packages.R --install    # install the missing ones

Figures are written as PNG and PDF; the PDF device is cairo, so on macOS
XQuartz must be installed or the PDF writes will fail while the PNGs succeed.
...
## Reproducing Figure 6d-f
    ...
    tables/aox/ptc_sham_windows.csv             the interval of every well
      ...
      -> scripts/76_figureS20.R               denoising and background-drift checks
